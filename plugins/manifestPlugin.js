/** adapted from https://forums.expo.dev/t/how-to-edit-android-manifest-was-build/65663/3 */
...
function addAttributesToMainActivity(androidManifest, attributes) {
  ...
  activity.$ = { ...activity.$, ...attributes.activity };
  application.$ = { ...application.$, ...attributes.application };
